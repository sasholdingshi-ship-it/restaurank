...
const DIR_LIST=[
    ...
    {id:'openai',icon:'<img src="https://www.google.com/s2/favicons?domain=chatgpt.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'ChatGPT / OpenAI',cat:'auto',desc:'Visibilité IA — données poussées automatiquement.',auto:true},
    {id:'perplexity',icon:'<img src="https://www.google.com/s2/favicons?domain=perplexity.ai&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Perplexity',cat:'auto',desc:'Visibilité IA — optimisation GEO automatique.',auto:true},
    {id:'claude',icon:'<img src="https://www.google.com/s2/favicons?domain=claude.ai&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Claude AI',cat:'auto',desc:'Visibilité IA — données structurées optimisées.',auto:true},
    {id:'gemini',icon:'<img src="https://www.google.com/s2/favicons?domain=gemini.google.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Gemini / Google AI',cat:'auto',desc:'Visibilité IA — via Google Business Profile.',auto:true},
    {id:'alexa',icon:'<img src="https://www.google.com/s2/favicons?domain=amazon.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Amazon Alexa',cat:'auto',desc:'Recherche vocale — données synchronisées.',auto:true},
    {id:'siri',icon:'<img src="https://www.google.com/s2/favicons?domain=apple.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Siri / Apple',cat:'auto',desc:'Recherche vocale — via Apple Business Connect.',auto:true},
    ...
    {id:'mapquest',icon:'<img src="https://www.google.com/s2/favicons?domain=mapquest.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'MapQuest',cat:'auto',desc:'Navigation — données synchronisées.',auto:true},
    {id:'here',icon:'<img src="https://www.google.com/s2/favicons?domain=here.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'HERE Maps',cat:'auto',desc:'Navigation — données poussées automatiquement.',auto:true},
    {id:'tomtom',icon:'<img src="https://www.google.com/s2/favicons?domain=tomtom.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'TomTom',cat:'auto',desc:'Navigation — synchronisé via Foursquare.',auto:true},
    {id:'snapchat',icon:'<img src="https://www.google.com/s2/favicons?domain=snapchat.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Snap Maps',cat:'auto',desc:'Carte — données synchronisées via Foursquare.',auto:true},
    {id:'aroundme',icon:'<img src="https://www.google.com/s2/favicons?domain=aroundme.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'AroundMe',cat:'auto',desc:'Découverte locale — données synchronisées.',auto:true},
    {id:'localeze',icon:'<img src="https://www.google.com/s2/favicons?domain=neustar.biz&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Localeze / Neustar',cat:'auto',desc:'Agrégateur — distribution automatique.',auto:true},
    {id:'factual',icon:'<img src="https://www.google.com/s2/favicons?domain=foursquare.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Factual / Foursquare',cat:'auto',desc:'Agrégateur — données synchronisées.',auto:true},
    {id:'infogroup',icon:'<img src="https://www.google.com/s2/favicons?domain=data.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Data.com / Infogroup',cat:'auto',desc:'Agrégateur — distribution automatique.',auto:true},
    {id:'acxiom',icon:'<img src="https://www.google.com/s2/favicons?domain=acxiom.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Acxiom',cat:'auto',desc:'Agrégateur — données poussées.',auto:true},
    ...
    {id:'cylex',icon:'<img src="https://www.google.com/s2/favicons?domain=cylex.fr&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Cylex',cat:'auto',desc:'Annuaire — données synchronisées.',auto:true},
    {id:'europages',icon:'<img src="https://www.google.com/s2/favicons?domain=europages.fr&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Europages',cat:'auto',desc:'Annuaire européen — données poussées.',auto:true},
    {id:'hotfrog',icon:'<img src="https://www.google.com/s2/favicons?domain=hotfrog.fr&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Hotfrog',cat:'auto',desc:'Annuaire — données synchronisées.',auto:true},
    {id:'brownbook',icon:'<img src="https://www.google.com/s2/favicons?domain=brownbook.net&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Brownbook',cat:'auto',desc:'Annuaire — données synchronisées.',auto:true},
    {id:'citysearch',icon:'<img src="https://www.google.com/s2/favicons?domain=citysearch.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Citysearch',cat:'auto',desc:'Découverte locale — données poussées.',auto:true},
    {id:'navmii',icon:'<img src="https://www.google.com/s2/favicons?domain=navmii.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Navmii',cat:'auto',desc:'Navigation — données synchronisées.',auto:true},
    {id:'uber',icon:'<img src="https://www.google.com/s2/favicons?domain=uber.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Uber',cat:'auto',desc:'Transport — lieu synchronisé.',auto:true},
    {id:'118712',icon:'<img src="https://www.google.com/s2/favicons?domain=118712.fr&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'118 712',cat:'auto',desc:'Annuaire téléphonique — données poussées.',auto:true},
    {id:'mappy',icon:'<img src="https://www.google.com/s2/favicons?domain=mappy.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Mappy',cat:'auto',desc:'Navigation France — données synchronisées.',auto:true},
    {id:'michelin',icon:'<img src="https://www.google.com/s2/favicons?domain=guide.michelin.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Guide Michelin',cat:'auto',desc:'Guide restaurant — données synchronisées.',auto:true},
    {id:'linternaute',icon:'<img src="https://www.google.com/s2/favicons?domain=linternaute.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'L\'Internaute',cat:'auto',desc:'Annuaire — données synchronisées.',auto:true},
    {id:'petit_fute',icon:'<img src="https://www.google.com/s2/favicons?domain=petitfute.com&sz=64" style="width:100%;height:100%;border-radius:inherit;object-fit:cover;display:block;">',name:'Petit Futé',cat:'auto',desc:'Guide voyage — données synchronisées.',auto:true},
    // ── Réseaux sociaux ──
...
async function generateBlogPost(){
    ...
    try{
        ...
        const wpBtn=`<button onclick="publishToWordPress()" style="padding:4px 12px;background:#f8e5db;color:#031c33;border:1px solid #031c3340;border:none;border-radius:6px;cursor:pointer;font-size:.72rem;">WordPress</button>`;
