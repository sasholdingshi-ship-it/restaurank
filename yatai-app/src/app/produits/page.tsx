  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div><h1 className="text-2xl font-bold text-gray-900">Recap Prix</h1><p className="text-sm text-gray-500">{products.length} produits — Prix de revente aux franchisés</p></div>
        <input type="text" placeholder="Rechercher un produit..." value={search} onChange={e => setSearch(e.target.value)} className="rounded-lg border border-gray-300 px-4 py-2 text-sm w-64" />
      </div>
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <table className="w-full text-sm">
          <thead><tr className="bg-gray-50 text-xs text-gray-500 uppercase">
            <th className="px-6 py-3 text-left">Réf</th><th className="px-6 py-3 text-left">Nom</th>
            <th className="px-6 py-3 text-right">Prix HT</th><th className="px-6 py-3 text-left">Unité</th>
